...
## 3. Sơ Đồ Dây Nối (Wiring Diagrams)
...
## 4. Bản Đồ Bộ Nhớ (Memory Map)

### 4.1. Flash Memory (2MB = 0x200000 bytes)
```
0x08000000 ─────────┐
            ...     │ Sector 0-22: Code + Constants (1920 KB)
0x081DFFFF ─────────┤
...
### 4.2. SDRAM Memory (8MB = 0x800000 bytes)
```
0xD0000000 ─────────┐
...
### 4.3. Internal RAM (192 KB = 0x30000 bytes)
```
0x20000000 ─────────┐
...
## 5. Cấu Hình Xung Nhịp (Clock Configuration)

### 5.1. Sơ Đồ Clock Tree
```
...
## 6. Cấu Hình Ngoại Vi (Peripheral Configuration)

### 6.1. LTDC (LCD-TFT Display Controller)
...
### 6.2. DMA2D (Graphics Accelerator)
...
- [IS42S16400J SDRAM](https://www.issi.com/WW/pdf/42S16400J.pdf)
- [STMPE811 Touch Controller](https://www.freescale.com/files/sensors/doc/app_note/AN3969.pdf)
- [L3GD20 Gyroscope](https://www.st.com/resource/en/datasheet/l3gd20.pdf)

### Design Tools
- **STM32CubeMX**: Hardware configuration, clock tree, pin mapping
- **TouchGFX Designer**: UI/Graphics design
- **STM32CubeIDE**: Compilation, debugging, programming
